...
<script>
import { tableOption } from '@/crud/active/apply'
...
export default {
  ...
  methods: {
    getDataList (page, params) {
      ...
      this.$http({
        url: this.$http.adornUrl('/science/activity/getSignUpActivityList'),
        method: 'get',
    ...
    deleteHandle (id) {
      this.$confirm('确定进行删除操作?', '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/science/activity/delete/' + id),
          method: 'delete',
